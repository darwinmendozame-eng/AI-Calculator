...
├── core/constants/
│   └── calculator.constants.js   # Colores, botones, operadores
└── domain/entities/
...
- **CalculatorView**: Contenedor principal con sombra naranja y borde
- **Display**: Muestra expresión y resultado
- **ButtonGrid**: Distribución de botones 4x4
- **Button**: Botón individual con estilos según tipo (number/operator/function/equals)

### Estilos (Tailwind CSS)

- Fondo body: `#0d0d0d` (oscuro)
- Fondo calculadora: `#1a1a1a`
- Botones números: `#4a4a4a`
- Botones operadores/equals: `#FF6B35` (naranja)
- Botones función (AC, +/-, %): `#2d2d2d`
- Sombras y bordes con acentos naranjas
...
- Maquetación completada sin funcionalidad
- Tipo de datos: JavaScript (TypeScript planned para futuras versiones)
